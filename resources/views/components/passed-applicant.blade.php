<div class=" flex justify-start items-center space-x-10">
    <button onclick="togglePassed()" class=" m-2 bg-red-500 rounded-xl p-2 hover:bg-red-700 transition-all duration-200"><x-heroicon-o-x-mark class="text-white size-5"/></button>
